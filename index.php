					...
					<div class="sq-ordered-list">
						...
						<div class="sq-list-item">
							<div class="sq-list-header">
								...
								<h3>RS WooCommerce Orders on Profile</h3>
								<h4><a href="https://github.com/RadGH/RS-WooCommerce-Orders-on-Profile" target="_blank">github.com/RadGH/RS-WooCommerce-Orders-on-Profile</a></h4>
							</div>
							
							<div class="sq-list-content">
								<p>Displays a user's WooCommerce orders on their user profile, inside a table.</p>
							</div>
							
							<div class="sq-list-image">
								<img src="<?php echo return_base64_url( 'images/plugins/rs-woocommerce-orders-on-profile.png' ); ?>" alt="An example order table showcasing different combinations of data that can be displayed.">
							</div>
						</div>
						...
						<div class="sq-list-item">
							<div class="sq-list-header">
								...
								<h3>RS WooCommerce Order Messages</h3>
								<h4><a href="https://github.com/RadGH/RS-WooCommerce-Order-Messages" target="_blank">github.com/RadGH/RS-WooCommerce-Order-Messages</a></h4>
							</div>
							
							<div class="sq-list-content">
								<p>Adds configurable messages that appear on order complete pages and in order emails. Messages can be set globally or per-product, and can be limited to specific order statuses.</p>
							</div>
							
							<div class="sq-list-image">
								<img src="<?php echo return_base64_url( 'images/plugins/rs-woocommerce-order-messages.png' ); ?>" alt="The settings page showing an option to appear on completed orders.">
							</div>
						</div>
						...
						<div class="sq-list-item">
							<div class="sq-list-header">
								<div class="date">October 2018</div>
								<h3>RS Preview WooCommerce Emails</h3>
								<h4><a href="https://github.com/RadGH/RS-Preview-WooCommerce-Emails" target="_blank">github.com/RadGH/RS-Preview-WooCommerce-Emails</a></h4>
							</div>
							
							<div class="sq-list-content">
								<p>Adds the ability to preview all WooCommerce order emails in a popup without sending an email.</p>
							</div>
							
							<div class="sq-list-image">
								<img src="<?php echo return_base64_url( 'images/plugins/rs-preview-woocommerce-emails.png' ); ?>" alt="The new options added to the Order Actions dropdown.">
							</div>
						</div>
						...
						<div class="sq-list-item">
							<div class="sq-list-header">
								...
								<h3>RS Image Sizes Media Column</h3>
								<h4><a href="https://github.com/RadGH/RS-Image-Sizes-Media-Column" target="_blank">github.com/RadGH/RS-Image-Sizes-Media-Column</a></h4>
							</div>
							
							<div class="sq-list-content">
								<p>Easily find and review the various image sizes generated by WordPress on the Media screen for all of your images.</p>
							</div>
							
							<div class="sq-list-image">
								<img src="<?php echo return_base64_url( 'images/plugins/rs-media-image-sizes-column.png' ); ?>" alt="Screenshot showing the new Media URL column added to the media screen in WordPress">
							</div>
						</div>
